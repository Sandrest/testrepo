...
export class BookService {
  ...
  searchBooks(searchTerm: string, pageIndex: number, pageSize: number): Observable<Page<Book>> {
    const url = `${this.baseUrl}/book/getBooks?searchTerm=${searchTerm}&pageIndex=${pageIndex}&pageSize=${pageSize}`;
